...
??? У объявления есть статусы: `OPEN`, `CLOSED`. Необходимо валидировать, что у пользователя не больше 10 открытых объявлений. - при достижении лимита изменить статус не выходит.... как сделать чтоб можно было менять????
